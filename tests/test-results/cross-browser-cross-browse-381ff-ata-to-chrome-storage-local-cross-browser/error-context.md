...
- Name: cross-browser\cross-browser.spec.ts >> Cross-Browser Storage Persistence >> should persist form data to chrome.storage.local
- Location: cross-browser\cross-browser.spec.ts:46:7
