...
- Name: offline\offline.spec.ts >> Offline: UI Feedback & Error Handling >> should prevent user confusion with clear offline messaging
- Location: offline\offline.spec.ts:359:7
