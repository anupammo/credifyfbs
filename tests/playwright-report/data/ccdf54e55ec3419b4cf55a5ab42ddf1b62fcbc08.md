...
- Name: offline\offline.spec.ts >> Offline: UI Feedback & Error Handling >> should handle sync errors gracefully (no data loss)
- Location: offline\offline.spec.ts:381:7
